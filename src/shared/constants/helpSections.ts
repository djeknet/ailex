...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    videoFile: "videos/model-filter.mp4",
    category: 'chat',
  },
  {
    id: 'site-prompts',
    ...
    videoFile: "videos/site-prompts.mp4",
    category: 'chat',
  },
  {
    id: 'fullscreen-mode',
    ...
    videoFile: "videos/fullscreen.mp4",
    category: 'chat',
  },
  {
    id: 'message-editing',
    ...
    videoFile: "videos/compare-responces.mp4",
    category: 'chat',
  },
  {
    id: 'message-consul',
    titleKey: 'helpTitle_messageConsul',
    descriptionKey: 'helpDescription_messageConsul',
  ...
  // Медиа и прикрепления
  {
    ...
    videoFile: "videos/files-attach.mp4",
    category: 'media',
  },
  {
    ...
    videoFile: "videos/screenshot.mp4",
    category: 'media',
  },
  {
    id: 'tab-mentions',
  ...
  // Контекстные меню
  {
    ...
    videoFile: "videos/selected-context.mp4",
  ...
  },
  {
    ...
    videoFile: "videos/fill-form.mp4",
    category: 'context-menu',
  },
